...
- Whisper Base and optional Small multilingual weights (OpenAI Whisper conversion): MIT.
...
`setup_native_engines.py` pins all dependency SHA-256 values. The Whisper archive hash
