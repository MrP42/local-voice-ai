  ...
  return (
    <div className="w-full space-y-6">
      <SettingsGroup title={t("tts.settingsTitle")}>
        ...
        >
          <div className="w-48">
            <Select
              ...
              options={[
                {
                  value: DEFAULT_TAG_PROVIDER_UI_VALUE,
                ...
                ...(hasAnthropicKey
                  ? [
                      {
                        value: "anthropic",
                        label: t("tts.autotag.providerClaude"),
                      },
                    ]
                  : []),
              ]}
        ...
        <SettingContainer
          title={t("tts.settings.tagLanguage")}
          description={t("tts.settings.tagLanguageDescription")}
          grouped={true}
          layout="horizontal"
        >
          <div className="w-48">
            <Select
              value={getSetting("tts_tag_language") ?? "auto"}
              options={[
                { value: "auto", label: t("tts.settings.tagLanguageAuto") },
                { value: "de", label: "Deutsch" },
                { value: "en", label: "English" },
              ]}
              isClearable={false}
              onChange={(value) =>
                updateSetting("tts_tag_language", value ?? "auto")
              }
            />
          </div>
        </SettingContainer>
        ...
        >
          <div className="w-48">
            <Select
              ...
              isClearable={false}
              onChange={(value) =>
                updateSetting("tts_tag_device", value ?? "auto")
              }
            />
          </div>
        </SettingContainer>
